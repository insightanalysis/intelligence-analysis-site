...
export default function HomePage() {
  ...
  useEffect(() => {
    // You will connect to WordPress later, for now dummy example:
    setResearchPosts([{ id: 1, title: "Research 1", year: "2025", excerpt: "Summary of Research 1" }]);
    setPublicationPosts([{ id: 1, title: "Publication 1", year: "2025", author: "John Doe" }]);
  }, []);
